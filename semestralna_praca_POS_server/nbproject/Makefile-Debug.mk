...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/semestralna_praca_pos_server

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/semestralna_praca_pos_server: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/semestralna_praca_pos_server ${OBJECTFILES} ${LDLIBSOPTIONS} -lpthread
